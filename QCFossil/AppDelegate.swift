...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func applicationWillResignActive(application: UIApplication) {
        ...
        NSNotificationCenter.defaultCenter().postNotificationName("triggerBackgroundRun", object: nil,userInfo: nil)
    }
    ...
    func applicationDidBecomeActive(application: UIApplication) {
        ...
        NSNotificationCenter.defaultCenter().postNotificationName("runTasksDidBecomeActive", object: nil,userInfo: nil)
    }
